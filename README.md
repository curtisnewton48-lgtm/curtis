...
- `STAR_BANK_MODEL_PROVIDER`
- `STAR_BANK_MODEL_NAME`
...
STAR_BANK_MODEL_PROVIDER=mistral
STAR_BANK_MODEL_NAME=ministral-8b-2512
PORTAL_ANSWER_MODEL_PROVIDER=deepseek
PORTAL_ANSWER_MODEL_NAME=deepseek-v4-pro
